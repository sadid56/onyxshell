...
Popup {
    ...
    Timer {
        ...
        running: false
        repeat: false
        onTriggered: errorWindow.isCopied = false
    }
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                MouseArea { id: closeHoverArea; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: errorWindow.active = false }
            }
        }
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                color: copyBtnHover.containsMouse ? Qt.rgba(errorWindow.theme.getColor("surfaceVariant").r, errorWindow.theme.getColor("surfaceVariant").g, errorWindow.theme.getColor("surfaceVariant").b, 0.8) : errorWindow.theme.getColor("surfaceVariant")
                border.width: 1; border.color: errorWindow.theme.getColor("outline")
                Behavior on color { ColorAnimation { duration: 150 } }
                ...
                MouseArea {
                    ...
                    onClicked: { Quickshell.execDetached(["bash", "-c", "printf '%s' \"$1\" | wl-copy", "copy-error", errorWindow.errorText]); errorWindow.isCopied = true; copyTimer.restart(); }
                }
            }
