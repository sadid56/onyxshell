...
QtObject {
    ...
    function closeAllPopupsExcept(excludeLoader) {
        var loaders = [dashboardLoader, notifsLoader, calendarLoader, wifiLoader, resourcesLoader, emojiLoader, clipboardLoader, wallpaperSelectorLoader, powerMenuLoader, mediaLoader];
