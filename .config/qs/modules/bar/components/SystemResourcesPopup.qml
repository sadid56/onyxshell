...
PanelWindow {
    ...
    property int telemetrySamplesCount: 0
    readonly property bool isProcessesLoading: appsModel.count === 0 && telemetrySamplesCount < 2

    function applyTelemetry(parsed) {
        resourceWindow.telemetryData = parsed;
        resourceWindow.telemetrySamplesCount++;
        ...
        ColumnLayout {
            ...
            Item {
                ...
                UI.SkeletonLoader {
                    ...
                    opacity: resourceWindow.isProcessesLoading ? 1.0 : 0.0
                ...
                ListView {
                    ...
                    visible: opacity > 0.01
                    opacity: resourceWindow.isProcessesLoading ? 0.0 : 1.0
                    Behavior on opacity { NumberAnimation { duration: 250; easing.type: Easing.OutQuad } }
                    move: Transition {
