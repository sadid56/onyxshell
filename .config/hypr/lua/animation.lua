...
hl.animation({ leaf = "windowsOut",       enabled = true, speed = 2.5, bezier = "smooth_decel", style = "popin 80%" })
...
hl.animation({ leaf = "fade",             enabled = true, speed = 3.0, bezier = "smooth_decel" })
hl.animation({ leaf = "fadeIn",           enabled = true, speed = 3.0, bezier = "smooth_decel" })
hl.animation({ leaf = "fadeOut",          enabled = true, speed = 2.5, bezier = "smooth_decel" })
