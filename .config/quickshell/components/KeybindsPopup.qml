...
PanelWindow {
    ...
    property var keybindsProc: Process {
        id: keybindsProc
        command: ["python", "/home/sadid/.config/quickshell/scripts/list_keybinds.py"]
    ...
    // Fullscreen MouseArea: clicking outside closes the modal
    MouseArea {
        anchors.fill: parent
